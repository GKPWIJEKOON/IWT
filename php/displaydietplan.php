...
<a class="btn btn-primary" href="./appdietplan.php" role="button">New Appointment</a>
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                    ...
                    <td>" . $row["Time"] . "</td>
                    <td>
                        <a class='btn btn-primary btn-sm' href='./updateappdietplan.php?Appid=$row[Appid];'>Edit</a>
                        <a class='btn btn-danger btn-sm' href='./deletedietplan.php?Appid=$row[Appid];'>Delete</a>
                    </td>
                </tr>";
            }

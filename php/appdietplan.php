    ...
    <form action="" method="post">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <h3 class="title"> Appointment For Diet plan</h3>
                <strong>Patient Details</strong>

                <div class="inputBox">
                    <span>full name :</span>
                    <input type="text" name="name" placeholder="Mr.kumara siriwardhana" required>
                </div>
                <div class="inputBox">
                    <span>email :</span>
                    <input type="email" name="email" placeholder="kumara3165@gmail.com" required>
                </div>
                <div class="flex">
                    <div class="inputBox">
                        <h3>Gender:</h3>
                    ...
                    <div class="inputBox">
                        <h3>Phone number:</h3>
                        <input type="text" name="pnumber" placeholder="+94">
                    </div>
                </div>
                <h1><u>channeling Details</u></h1>
                <div class="inputBox">
                    <span>Nutrition Name:</span>
                    <input type="text" name="Nutrition_name" placeholder="Mr." required>
                </div>
                <div class="inputBox">
                ...
                <div class="flex">
                    ...
                    <div class="inputBox">
                        ...
                        <select class="custom-select" name="Time">
                            <option value="8.30-10.30 AM" name="method">8.30-10.30 AM</option>
                            <option value="10.30-12.30 PM" name="method">10.30-12.30 PM</option>
                            <option value="12.30-2.30 PM" name="method">12.30-2.30 PM</option>
                            <option value="2.30-4.30 PM" name="method">2.30-4.30 PM</option>
                            <option value="4.30-6.30 PM" name="method">4.30-6.30 PM</option>
                            <option value="6.30-8.30 PM" name="method">6.30-8.30 PM</option>
                        </select>                        
                    </div>
                </div>
            </div>
        ...
        <button type="submit" name="submit" class="btn btn-primary btn-lg" onclick = "SubmitAppointment();">Submit Appointment</button>
...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO diatplanappointment (Fullname, Email, Gender, Age, pnumber, Nutrition_name, City, Date, Time) 
